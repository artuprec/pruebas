...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar 31 10:33:53 2022
...
class Monitor():
    ...
    def leaves_tunnel(self, direction):
        ...
        if direction == NORTH:
            ...
            if self.north_passed.value == 1 or self.south_waiting.value != 0 :
            ...
            if self.south_passed.value == 1 or self.north_waiting.value != 0 :
